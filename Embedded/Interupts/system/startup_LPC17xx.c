...
void rcscheduler_Timer0_IRQHandler(void) ALIAS(Default_Handler);
...
void rcuart_PORT1_IRQHandler(void) ALIAS(Default_Handler);
...
{      
	...
	rcscheduler_Timer0_IRQHandler,                      // 17, 0x44 - TIMER0
    TIMER1_IRQHandler,                      // 18, 0x48 - TIMER1
    TIMER2_IRQHandler,                      // 19, 0x4c - TIMER2
    TIMER3_IRQHandler,                      // 20, 0x50 - TIMER3
    UART0_IRQHandler,                       // 21, 0x54 - UART0
	rcuart_PORT1_IRQHandler,                       // 22, 0x58 - UART1
