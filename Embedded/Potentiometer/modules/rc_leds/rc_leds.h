...
typedef enum E_RCLEDS_STATE {
	...
	E_RCLEDS_STATE_RED1,				//!< E_RCLEDS_STATE_RED1
	E_RCLEDS_STATE_GREEN1,				//!< E_RCLEDS_STATE_GREEN1
	E_RCLEDS_STATE_BLUE1,				//!< E_RCLEDS_STATE_BLUE1
	E_RCLEDS_STATE_RED2,				//!< E_RCLEDS_STATE_RED2
	E_RCLEDS_STATE_GREEN2,				//!< E_RCLEDS_STATE_GREEN2
	E_RCLEDS_STATE_BLUE2,				//!< E_RCLEDS_STATE_BLUE2
} T_E_RCLEDS_STATE;
