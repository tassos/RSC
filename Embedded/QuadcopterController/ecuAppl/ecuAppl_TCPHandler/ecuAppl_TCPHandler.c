...
//	}
	...
	memcpy(x.buffer,&bigBuffer[0],8);
	memcpy(y.buffer,&bigBuffer[8],8);
	memcpy(z.buffer,&bigBuffer[16],8);
	memcpy(phi.buffer,&bigBuffer[24],8);
	memcpy(theta.buffer,&bigBuffer[32],8);
	memcpy(psi.buffer,&bigBuffer[40],8);
	memcpy(xd.buffer,&bigBuffer[48],8);
	memcpy(yd.buffer,&bigBuffer[56],8);
	memcpy(zd.buffer,&bigBuffer[64],8);
	memcpy(phid.buffer,&bigBuffer[72],8);
	memcpy(thetad.buffer,&bigBuffer[80],8);
	memcpy(psid.buffer,&bigBuffer[88],8);
