...
void ecuAppl_Scheduler_Timer0_IRQHandler(void) ALIAS(Default_Handler);
void ecuDrv_timer_Timer1_IRQHandler(void) ALIAS(Default_Handler);
...
void ecuDrv_uart_PORT1_IRQHandler(void) ALIAS(Default_Handler);
void UART2_IRQHandler(void) ALIAS(Default_Handler);
void ecuDrv_uart_PORT3_IRQHandler(void) ALIAS(Default_Handler);
...
{      
	...
	ecuAppl_Scheduler_Timer0_IRQHandler,    // 17, 0x44 - TIMER0
	ecuDrv_timer_Timer1_IRQHandler,         // 18, 0x48 - TIMER1
    TIMER2_IRQHandler,                      // 19, 0x4c - TIMER2
    TIMER3_IRQHandler,                      // 20, 0x50 - TIMER3
    UART0_IRQHandler,                       // 21, 0x54 - UART0
	ecuDrv_uart_PORT1_IRQHandler,                       // 22, 0x58 - UART1
    UART2_IRQHandler,                       // 23, 0x5c - UART2
	ecuDrv_uart_PORT3_IRQHandler,                       // 24, 0x60 - UART3
