...
/** @defgroup EMAC_Configuration_Options
 * @{
 */

/** Use LPC17xx Timer0 to implement delay function */
#define USE_LPC17XX_TIMER0 0
/** Put EMAC variables in AHB SRAM */
#define USE_EMAC_DESC_IN_AHB_SRAM 1
/** Use AHB SRAM Bank 0. If not set Bank 1 will be used */
#define USE_AHB_BANK0 0
...
/* Receive Buffer Base Address Register */
//
...
#define EMAC_LAN8720_DEF_ADR     0x0100      /**< Default PHY device address        */
#define EMAC_LAN8720_ID          0x0007C0F0  /* PHY Identifier                    */
